...
router.post('/generate', [
    ...
    (0, express_validator_1.body)('period').isString(),
    (0, express_validator_1.body)('format').optional().isIn(['JSON', 'PDF', 'EXCEL'])
], async (req, res) => {
    try {
